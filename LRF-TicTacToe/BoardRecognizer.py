...
class BoardRecognizer:
    ...
    def __init__(self, settings):
        ...
        self.CellMinArea = settings.get("BoardDetector","CellMinArea")
        self.CellMaxArea = settings.get("BoardDetector","CellMaxArea")
        self.ContentMinArea = settings.get("BoardDetector","ContentMinArea")
        self.ContentMaxArea = settings.get("BoardDetector","ContentMaxArea")
    ...
    def __SaveContournsImages(self, contours, img, name):
        ...
        for imgCnt in self.__ExtractContournsOnImage(contours,img):
            ...
            cv2.imwrite(str(name)+"-"+str(number)+".jpg",imgCnt)
...
class OpticalBoard:
    ...
    def __init__ (self, settings):
        ...
        for pos in settings.get("OpticalBoard","Positions"):
